...
public class CinemaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Cinema";
	...
	private CinemaPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Password_reset.class);
		aMetadataSources.addAnnotatedClass(News.class);
		aMetadataSources.addAnnotatedClass(Users.class);
		aMetadataSources.addAnnotatedClass(Feedback.class);
		aMetadataSources.addAnnotatedClass(Films.class);
		aMetadataSources.addAnnotatedClass(Category.class);
		aMetadataSources.addAnnotatedClass(Seans.class);
		aMetadataSources.addAnnotatedClass(Hall.class);
		aMetadataSources.addAnnotatedClass(Cinema.class);
		aMetadataSources.addAnnotatedClass(Reservations.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CinemaPersistentManager();
		}
